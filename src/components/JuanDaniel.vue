<template>
  <div class="juan-daniel-container">
    <header>
      <h1>Juan Daniel Hernández Mancilla</h1>
    </header>
    ...
    <main>
      ...
      <section id="contacto">
        ...
        <div class="social-links">
          ...
          <a href="https://github.com/DaniHDZM" target="_blank">
...
<script setup>
// Ya no necesitas el navbar aquí
</script>

<style scoped>
.juan-daniel-container {
  min-height: 100vh;
}
